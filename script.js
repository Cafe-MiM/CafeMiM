...
class ModernMenu {
    ...
    init() {
        ...
        // this.addParallaxEffects(); // Disabled to prevent header movement
    ...
    switchCategory(targetCategory, clickedButton) {
        ...
        setTimeout(() => {
            ...
            // Remove automatic scrolling - let user scroll manually if they want
            this.isAnimating = false;
        }, 200);
    }
    ...
    addParallaxEffects() {
        // Remove parallax effects to keep headers static
        // This prevents the header from moving when scrolling
    }
